...
public class ListContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        Level level = tokens.size() < 2 ? null : Level.valueOf(tokens.get(1));
        List<Contest> contestByLevelWise = contestService.getAllContestLevelWise(level);
        System.out.println(contestByLevelWise);
    }
